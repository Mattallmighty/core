"""Support for Auckland Transport (NZ) to query next leave event."""
from datetime import timedelta

from TransportAT import TransportAT
...
ATTRIBUTION = "Data provided by Auckland Transport"
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    """Set up the Transport AT sensor."""
    ...
    add_entities([TransportATSensor(data, stop_id, name)], True)


class TransportATSensor(Entity):
    """Implementation of an Transport AT sensor."""
    ...
    def update(self):
        """Get the latest data from Auckland Transport and update the states."""
        self.data.update()
...
class PublicTransportData:
    ...
    def __init__(self, stop_id, route, destination, api_key):
        ...
        self.tat = TransportAT()

    def update(self):
        """Get the next leave time."""
        _data = self.tat.get_departures(
